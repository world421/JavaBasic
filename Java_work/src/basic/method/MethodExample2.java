...
public class MethodExample2 {
	...
	// 매개변수가 필요없는 경우
	static String selectRandomFood(){ //리턴하고자 하는 값이랑 일치해야함 
	...
	static int calcNumberTotal(int[] nums) { //배열에 싸서보내기
		int total =0;
...
//		}
	...
	static int calcNumberTotal2(int... nums) { //int ... 크기가 변한다 : 가변인수
		int total = 0;
		for(int n : nums) {
			total +=n;
		}	
	...
	public static void main(String[] args) {
		...
		System.out.println("오늘 점심 뭐먹지??? : "+ selectRandomFood()); //method 는 호출한다는 의미로 () 필수 ! 
		...
		sum =calcNumberTotal2(1,2,3,4,5,6);
		System.out.println("누적합: " + sum);
	}
}
