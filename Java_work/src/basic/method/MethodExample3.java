...
7. 이 때는 반환유형을 메서드를 선언할 때 비워두지 마시고
 void라는 키워드를 작성해 주셔야 합니다. // !! void 메서드는 return 이 없다 
...
public class MethodExample3 {
	...
	static int[] operateTotal (int n1,int n2){
		return new int[] {n1+n2, n1-n2,n1*n2,n1/n2}; //return 은 반드시 한번만 ! 한번 호출에! 		
	}
...
////		double Avg = (double)calcArrayTotal(numstotal)/;
...
//		int r4 = multi(10,7); //안됩니다
//		System.out.println(multi(10,7)); // 값이 있어야 출력이된다 
		multi(10,7);
