...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// java 로 고정하고 싶은데 string타입이라 메롱도됨 ㅠ
		// enum 사용하면 상수이외 사용불가능  객체인데 상수열거용 객체
		...
		System.out.println(kim.lang.ordinal()); //kim의 :Languages는 몇번째에 있니
		
		System.out.println("-----------------------------");
		//valueOf(str): 매개값으로 전달된 문자열과 일치하는 요소를 리턴
		
		System.out.println(Languages.valueOf("CPP"));
//		System.out.println(Languages.valueOf("없는값")); // (X)예외
